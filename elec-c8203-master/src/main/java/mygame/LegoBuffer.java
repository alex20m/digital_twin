...
public class LegoBuffer {
	 ...
	 ArrayList<Lego> legos2 = new ArrayList(500);
	 ...
	 float zOffset, int rowSize, int columnSize, Boolean legoExist) {
		...
		"Common/MatDefs/Light/Lighting.j3md");
		 ...
		 String colorLego; // punainen lego tulee vain jos koodissasi on bugi
	...
	public Lego getLego(String color) {
