...
public class RobotArm {
	...
	public RobotArm(AssetManager assetManager, Node rootNode, String color) {
		...
		mat2.setColor("Diffuse", ColorRGBA.LightGray);

		
		mastGeom.setMaterial(mat2);
		xArmGeom.setMaterial(mat);
		yArmGeom.setMaterial(mat);
		zArmGeom.setMaterial(mat2);
